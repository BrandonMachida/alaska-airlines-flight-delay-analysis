-- Overall On-Time Performance (OTP) for Alaska Airlines
SELECT 
    carrier_code,
...
-- Average Delay Duration for Flights Considered Delayed by the FAA (>= 15 minutes) for Alaska Airlines
SELECT 
    carrier_code,
...
-- Percentage of Delays by Delay Type for Alaska Airlines
SELECT 
    carrier_code,
